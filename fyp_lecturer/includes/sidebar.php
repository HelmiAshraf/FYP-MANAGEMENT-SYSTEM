    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r  sm:translate-x-0 bg-gray-800 border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="fypl_proposal.php" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                ...
                <li>
                    <a href="fypl_lecturer.php" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        ...
                        <span class="ml-3">Lecturer</span>
                    </a>
                </li>
                <li>
                    <a href="fypl_form.php" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white">
