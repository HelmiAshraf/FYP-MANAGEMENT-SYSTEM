...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg -lg">
    <div class="p-4 bg-white dark:bg-gray-900 flex justify-between">
        ...
        <div>
            <a href="fypl_form_create.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none block">Upload Form</a>
        </div>
    </div>
