...
?>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6 bg-gray-800 text-gray-400 mb-4">
            <div class="">
                <h1 class="text-3xl font-bold mb-4 text-white ">Supervisor Details</h1>
                ...
                <div class="grid grid-cols-3 gap-4 ">
                    ...
                    <div class=" col-span-2 p-3">
                        <div class="flex items-center mb-6">
                            <img class='h-36 w-36 ' src='<?php echo $row['sv_image']; ?>' alt="Supervisor" class="w-32 h-32 rounded-lg -full mr-4">
                            <div class=" ml-8">
                                <div class="">
                                    <p class="font-semibold text-white text-lg"><?php echo $row['supervisor_name']; ?></p>
                    ...
                    <div class="rounded-lg p-3">
                        ...
                        <p class="<?php echo $statusColorClass; ?> font-semibold"><?php echo $projectStatusLabel; ?></p>
                    </div>
                </div>

                <h1 class="text-3xl font-bold mb-2 mt-4 text-white ">Propose Project Details</h1>
                <!-- Project details -->
                <div class="w-full p-3">
                    <div class=" flex items-center">
                        <div class="">
                            <div class="">
                                <p class="font-semibold text-white text-lg">Project Title</p>
                                <p class="text-gray-200"><?php echo $row['project_title']; ?></p>
                            </div>
                            <div class=" mt-2">
                                <p class="font-semibold text-white text-lg mb-2">Description</p>
                                <p class="text-gray-200 text-justify"><?php echo nl2br($row['project_description']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                            ...
                            <div class="w-full flex justify-end py-2 px-4  mt-5">
