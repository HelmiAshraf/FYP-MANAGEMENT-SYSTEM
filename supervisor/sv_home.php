...
<h1 class="text-2xl font-bold mb-4">Student Progress</h1>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='px-6 py-4'>" . $row["supervisor_PHnumber"] . "</td>";
                    ...
                    echo "<td class='px-6 py-4'>
                                <a href='st_propose_project.php' class='font-medium text-blue-600 dark:text-blue-500 hover:underline'>Choose</a>
                            </td>";
                    echo "</tr>";
                }
            } else {
